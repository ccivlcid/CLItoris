...
export default function ComposerBar() {
  ...
  const {
    draft, selectedLang, isSubmitting,
    attachedRepo,
      ...
      <div className="border-t border-[var(--bg-void)] px-5 py-2.5 flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 ml-auto">
          <select
            ...
            className="bg-[var(--bg-void)] border border-[var(--border-hover)] text-[var(--text-muted)] text-[11px] px-2 py-1 font-mono outline-none cursor-pointer"
          >
