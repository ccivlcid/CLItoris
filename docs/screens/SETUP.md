...
| **Description** | First-time profile configuration after GitHub OAuth. Displays data imported from GitHub (avatar, name, bio, repos count) and lets the user choose a CLItoris username. Only shown once on first connect. No sidebar -- full-width centered layout. |
