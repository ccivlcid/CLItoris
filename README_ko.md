...
<em>API가 있으면 연결됩니다. 로컬로 돌아가면 더 좋습니다. 에이전트면 채팅하세요.</em>
...
<td align="center" width="33%">
<h3>🤖 9+ AI 프로바이더</h3>
Claude, GPT-4o, Gemini, Ollama, OpenRouter, Together, Groq, Cerebras 및 모든 OpenAI 호환 엔드포인트.
</td>
<td align="center" width="33%">
<h3>💬 AI 에이전트 챗</h3>
...
<td align="center">
<h3>🔍 GitHub 탐색</h3>
트렌딩 레포, 저장소 및 사용자 검색 — 터미널 미학으로 구현된 GitHub 검색.
</td>
<td align="center">
<h3>📱 모바일 퍼스트</h3>
터치에 최적화된 설계. 하단 네비, 전체 화면 알림, 프로필 탭, 글래스 UI.
</td>
</tr>
<tr>
<td align="center">
